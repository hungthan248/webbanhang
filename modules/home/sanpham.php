...
<span>25.090.000</span>
            ...
            <div class="box-buy">
                ...
                <button class="btn-buy" type="submit">
                    <a style="color: aqua !important;"
                        href="<?php if(is_login()) echo "?mod=cart&act=add&id=$_GET[id]";?>><strong style=" color:
                        aqua;">MUA NGAY</strong></a>
            ...
            <div>
                <p style="font-size: 20px;"><?php echo $item['product_show'] ?> </p>
            </div>
        </div>
