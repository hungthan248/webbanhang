        ...
        <div class="product__info ">
            <a href="?mod=home&act=sanpham&id=<?php echo $list_item['id'] ?>" class="product__link">
                ...
                <div class="product_action">
                    <a href="<?php echo "?mod=product&act=update&id={$list_item['id']}" ?>" style="color:burlywood">
                        Thay
                        đổi
                        thông tin</a>
                    <a href="<?php echo "?mod=product&act=delete&id={$list_item['id']}" ?>" style="color:burlywood">
                        Xóa</a>
                </div>
...
<div class="nav">
    <form action="?mod=home&act=timkiem" method="POST">
        <ul>
            <li>HTshop</li>
            <li class="tk"><input class="tk_ip" type="text" placeholder="Tìm kiếm" name="noidung"> <button
                    class="tk_btn" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button></li>
            <li> hotline:19001000 </li>
            <?php 
if(is_login()){
?>
            <li><a href="?mod=product&act=add">
                    <div id="cart">
                        <div>
