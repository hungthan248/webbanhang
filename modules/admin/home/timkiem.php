...
$listProduct_search = array();
if (isset($_POST['noidung'])) {
$listProduct_search= get_product_by_search_name($_POST['noidung']);
if ($listProduct_search == null) {
    $listProduct_search= get_product_by_search($_POST['noidung']);
    
    }
}
if ($listProduct_search == null) {
$listProduct_search= get_product_by_search($_GET['search']);
...
?>
        ...
        <?php 
foreach($listProduct_search as $list_item) {
...
<div class="nav">
    <form action="?mod=home&act=timkiem" method="POST">
        <ul>
            <li><a href="?mod=home&act=admin" style="color:aqua ">HTshop</a></li>
            <li class="tk"><input class="tk_ip" type="text" placeholder="Tìm kiếm" name="noidung">
                <button class="tk_btn" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
            </li>
